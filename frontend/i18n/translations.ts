...
export const translations: Translations = {
    en: {
        ...
        register_page: {
            ...
            subtitle: "Join the Gaming Cafe community.",
            name_label: "Name",
            email_label: "Email",
            password_label: "Password",
        ...
        cases_teaser: {
            ...
            subtitle: 'Register and play at Gaming Cafe to earn promo codes and open these cases for amazing prizes!',
            cta: 'Register & Play'
        },
        cases_page: {
        ...
        food: {
            title: 'Food & <span class="text-purple-400">Drinks</span>',
            subtitle: 'Fuel your gaming session with our delicious food and refreshing drinks',
            drinks_title: 'Refreshing Drinks',
            snacks_title: 'Gaming Snacks',
            hot_meals_title: 'Hot Meals'
        },
        booking: {
        ...
        footer: {
            ...
            copyright: 'Gaming Cafe. All rights reserved.'
        },
        pricing: {
    ...
    az: {
        ...
        nav_links: [
            ...
            { id: 'food', label: 'Yemək və İçkilər' },
        ...
        register_page: {
            title: "Hesab Yarat",
            subtitle: "Gaming Cafe cəmiyyətinə qoşulun.",
            name_label: "Ad",
            email_label: "E-poçt",
            password_label: "Şifrə",
        ...
        cases_teaser: {
            ...
            subtitle: 'Möhtəşəm hədiyyələr üçün promo kodlar qazanmaq və bu keysləri açmaq üçün Gaming Cafe-da qeydiyyatdan keçin və oynayın!',
        ...
        food: {
            title: 'Yemək və <span class="text-purple-400">İçkilər</span>',
            subtitle: 'Oyun sessiyanız üçün ləzzətli yemək və təravətli içkilərlə enerjinizi artırın',
            drinks_title: 'Təravətli İçkilər',
            snacks_title: 'Oyun Qəlyanaltıları',
            hot_meals_title: 'İsti Yeməklər'
        },
        booking: {
        ...
        footer: {
            ...
            contact_title: 'Əlaqə',
            copyright: 'Gaming Cafe. Bütün hüququqlar qorunur.'
        },
        pricing: {
    ...
    ru: {
        ...
        register_page: {
            ...
            subtitle: "Присоединяйтесь к сообществу Gaming Cafe.",
            name_label: "Имя",
            email_label: "Электронная почта",
            password_label: "Пароль",
        ...
        cases_teaser: {
            ...
            subtitle: 'Регистрируйтесь и играйте в Gaming Cafe, чтобы зарабатывать промокоды и открывать эти кейсы с потрясающими призами!',
        ...
        food: {
            title: 'Еда и <span class="text-purple-400">Напитки</span>',
            subtitle: 'Подпитывайте свою игровую сессию вкусной едой и освежающими напитками',
            drinks_title: 'Освежающие Напитки',
            snacks_title: 'Игровые Закуски',
            hot_meals_title: 'Горячие Блюда'
        },
        booking: {
        ...
        footer: {
            ...
            copyright: 'Gaming Cafe. Все права защищены.'
        },
        pricing: {
