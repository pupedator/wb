...
const TeaserCaseDisplay: React.FC<{ caseItem: Case }> = ({ caseItem }) => (
    <div className="flex flex-col items-center text-center group">
        <img 
            src={caseItem.image} 
            alt={caseItem.name} 
            className="w-32 sm:w-40 lg:w-48 h-32 sm:h-40 lg:h-48 object-contain mb-3 sm:mb-4 drop-shadow-[0_5px_15px_rgba(147,51,234,0.2)] transition-transform duration-500 group-hover:scale-110 group-hover:drop-shadow-[0_8px_25px_rgba(147,51,234,0.4)]" 
        />
        <h3 className="text-lg sm:text-xl font-bold text-white">{caseItem.name}</h3>
    </div>
);
        ...
        <section id="cases-teaser" className="py-20 md:py-32 bg-neutral-950/90 backdrop-blur-sm">
            <div className="container mx-auto px-6 text-center">
                ...
                <button 
                    ...
                    className="glow-btn glow-btn-primary glow-btn-lg rounded-full"
                >
