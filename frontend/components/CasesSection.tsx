        ...
        <main className="min-h-screen pt-24 pb-16">
            <div className="container mx-auto px-6">
                 <div className="flex flex-col sm:flex-row justify-between items-center mb-6 sm:mb-8 gap-4">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white text-center sm:text-left" dangerouslySetInnerHTML={{ __html: t('cases.title') }} />
                    <button onClick={() => setPage('cabinet')} className="glow-btn glow-btn-primary glow-btn-md flex items-center space-x-2 w-full sm:w-auto justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 sm:h-5 w-4 sm:w-5 glow-icon" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v2H2v-4l4.257-4.257A6 6 0 1118 8zm-6-4a4 4 0 100 8 4 4 0 000-8z" clipRule="evenodd" /></svg>
                        <span className="text-sm sm:text-base">{t('cases_page.my_cabinet')}</span>
                    </button>
                </div>
                ...
                <div className="mt-12 sm:mt-16 md:mt-20 max-w-4xl mx-auto">
                     <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 text-white">{t('cases_page.history_title')}</h2>
