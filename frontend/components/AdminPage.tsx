...
import FoodEditor from './admin/FoodEditor.tsx';
import ImageManager from './admin/ImageManager.tsx';
import HeroContentEditor from './admin/HeroContentEditor.tsx';


// Defines the available tabs in the admin panel.
type AdminTab = 'users' | 'content' | 'cases' | 'promos' | 'food' | 'images' | 'hero';
...
const AdminPage: React.FC<{ setPage: (page: Page) => void }> = ({ setPage }) => {
    ...
    const renderActiveTab = () => {
        switch (activeTab) {
            ...
            case 'food': return <FoodEditor />;
            case 'images': return <ImageManager />;
            case 'hero': return <HeroContentEditor />;
            default: return null;
        }
    };
        ...
        <main className="min-h-screen pt-24 pb-16">
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-5xl mx-auto bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
                    <div className="flex items-center space-x-2 border-b border-neutral-700 pb-4 mb-6 flex-wrap gap-2">
                       <TabButton tabId="users" label={t('admin_page.user_management')} />
                       <TabButton tabId="hero" label="Hero Content" />
                       ...
                       <TabButton tabId="food" label="Food & Drinks" />
                       <TabButton tabId="images" label="Image Manager" />
                    </div>
