...
/**
 * Represents a food item in the cafe menu.
 */
export interface FoodItem {
  ...
  category?: MultilingualText; // Optional category for organization
...
/**
 * Represents the Food section configuration.
 */
export interface FoodSectionConfig {
