...
export type Page = 'home' | 'cases' | 'cabinet' | 'login' | 'admin' | 'register' | 'forgotPassword' | 'resetPassword' | 'otpVerification';
...
const App: React.FC = () => {
  ...
  return (
    ...
    <div className="text-neutral-200 font-sans antialiased relative overflow-x-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-[800px] bg-gradient-to-b from-purple-900/50 to-transparent -z-10 opacity-30"></div>
       <div className="absolute top-0 right-[-20%] w-96 h-96 bg-purple-600/20 rounded-full blur-3xl -z-10"></div>
